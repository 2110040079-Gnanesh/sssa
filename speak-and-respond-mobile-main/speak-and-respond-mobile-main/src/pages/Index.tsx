  ...
  const handleGenerateResponse = async () => {
    ...
    if (userCredits !== null && userCredits <= 0) {
      toast({
        ...
        description: "You've run out of credits. Please add more credits to continue.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      const hasCredits = await decrementUserCredits();
      
      if (!hasCredits) {
        throw new Error("You've run out of credits");
      }
